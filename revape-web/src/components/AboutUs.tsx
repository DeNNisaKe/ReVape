...
import aboutUsImage from "../about-us-photos/2.jpg";
...
const About3 = () => {
  return (
    <div
      className="bg-cover h-screen flex flex-col items-center justify-center text-white"
      style={{
        backgroundImage: `url(${backgroundImage})`,
      }}
    >
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 slideInUp">
        <div className="flex mt-16 lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
              It is our mission to ensure that vaping devices and accessories
              are recycled responsibly to reduce environmental impact. We are
              dedicated to making vaping recycling accessible and convenient for
              everyone.
            </h2>
          </div>
        ...
        <div className="relative mt-24">
          <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            <div className="z-20 w-12 h-12 bg-green-800 rounded-full flex justify-center items-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle cx="24" cy="24" r="24" fill="#2F855A" />
              <path
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div>
            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-white-800 mt-6">
              Founded
            </p>
            <p className="font-normal text-justify leading-6 text-white-600 mt-6">
              By two passionate advocates for environmental sustainability who
              saw a need for responsible disposal of vaping products.
            </p>
          </div>
          <div>
            <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-white-800 mt-6">
            ...
            <p className="font-normal text-justify leading-6 text-white-600 mt-6">
              To reduce the environmental impact of vaping by providing easy and
              accessible recycling solutions. We believe that through education
              and community engagement, we can inspire more people to recycle
          ...
          <div className="sm:block hidden">
            ...
            <p className="font-normal text-justify leading-6 text-white-600 mt-6">
              We aim to recycle thousands of vaping products, preventing harmful
              materials from ending up in landfills and contributing to a
              cleaner, healthier planet. We are committed to making this goal a
              reality.
            </p>
          </div>
        </div>
